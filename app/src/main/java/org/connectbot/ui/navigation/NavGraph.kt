...
import org.connectbot.ui.screens.mcp.McpSettingsScreen
...
fun ConnectBotNavHost(
    ...
    NavHost(
        ...
        composable(NavDestinations.HOST_LIST) {
            HostListScreen(
                ...
                onNavigateToMcpSettings = {
                    navController.navigateSafely(NavDestinations.MCP_SETTINGS)
                },
        ...
        composable(NavDestinations.MCP_SETTINGS) {
            McpSettingsScreen(
                onNavigateBack = { navController.safePopBackStack() },
            )
        }
